...
const postsDirectory = join(rootDir, 'content', '_posts')
const projectsDirectory = join(rootDir, 'content', '_projects')
const resumeDirectory = join(rootDir, 'content', '_resumes')
